...
from .ldh.ldhwiz import LDHWizard
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        self.mergebutton = self.generate_button('Merge contents of odmls\n',
                                                "mergeodml.svg")
        self.ldhbutton = self.generate_button('Upload to Local Data Hubs\n',
                                                "mergeodml.svg")
        ...
        grid.addWidget(self.ldhbutton, 3, 1)
